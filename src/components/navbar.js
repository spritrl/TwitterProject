...
const Navbar = ({ route, navigation, username }) => {
    ...
    if (!currentUser) {
      return (
        <Button style={button} component={Link} to={`/auth/profile`}>
         <LogoutIcon style={{color: 'white', ...svg}}/>
      ...
      return (
        ...
        <LoginIcon style={{color: 'white', ...svg}}/>
  ...
  return (
    <div style={root}>
      ...
      <Button style={button} component={Link} to="/">
      ...
      <Button style={button} component={Link} to={`/auth/profile?username=${currentUser ? currentUser.email : null}`}>
        <SvgIcon style={svg} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
